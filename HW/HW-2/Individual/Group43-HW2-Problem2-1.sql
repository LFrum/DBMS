/* 
    Setup new tables for our sets and relations: Performer, Movie, Acted, and Director
*/
...
INSERT INTO Movie 
    (mname, genre, minutes, release_year, did, imdb_rating)
VALUES
    ('Jurassic Park',        'Action',    125, 1984, 2, 8.1),
    ('Shawshank Redemption', 'Drama',     105, 2001, 2, 9.3),
    ('Fight Club',           'Drama',     144, 2015, 2, 8.8),
    ('The Departed',         'Drama',     130, 1969, 3, 8.5),
    ('Back to the Future',   'Comedy',     89, 2008, 3, 7.4),
    ('The Lion King',        'Animation',  97, 1990, 1, 8.5),
    ('Alien',                'Sci-Fi',    115, 2006, 3, 8.4),
    ('Toy Story',            'Animation', 104, 1978, 1, 8.3),
    ('Scarface',             'Drama',     124, 2003, 1, 7.8),
    ('Up',                   'Animation', 111, 1999, 4, 8.2);
